...
import { API_URL, WS_URL } from '../shared/config/config';
import type { GameState, TowerType } from '../types';
import GameCanvas, { GameCanvasHandle } from '../features/game/components/GameCanvas';
...
import TowerSelector from '../features/hud/components/TowerSelector';
